...
root.title('Minh Thanh - Countdown Clock And Timer')
Label(root, text='Countdown Clock and Timer',
      font='arial 20 bold',  bg='papaya whip').pack()


#display current time#######################

Label(root, font='arial 15 bold', text='Current time :',
      bg='papaya whip').place(x=40, y=70)
...
Button(root, text='START', bd='5', command=countdown,
       bg='antique white', font='arial 10 bold').place(x=150, y=210)
